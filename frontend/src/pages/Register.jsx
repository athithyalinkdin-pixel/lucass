    ...
    <div className="pt-32 pb-24 min-h-screen bg-bg-off-white flex items-center justify-center">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-primary italic font-serif">Join the Transformation</h1>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full flex items-center justify-center gap-3 py-4 mt-4 font-bold"
          >
