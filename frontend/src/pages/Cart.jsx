      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-24 bg-white rounded-[2rem] shadow-premium">
            ...
            <p className="text-primary/60 mb-8 font-medium">
              Looks like you haven't added any natural solutions yet.
            </p>
                  ...
                  >
                    ...
                    <div className="w-24 h-24 bg-accent/20 rounded-2xl flex items-center justify-center overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = 'https://placehold.co/150x150?text=Ayurveda';
                        }}
                      />
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="glass-card p-8 sticky top-32">
                ...
                <div className="space-y-4 mb-8 pb-8 border-b border-accent">
                  <div className="flex justify-between text-primary/60 font-semibold text-sm">
                    <span>Subtotal</span>
                    <span>₹{cartTotal}</span>
                  </div>
                  <div className="flex justify-between text-primary/60 font-semibold text-sm">
                ...
                <div className="flex justify-between text-2xl font-bold text-primary mb-8 font-serif">
                  <span>Total</span>
                  <span>₹{cartTotal}</span>
                </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-xs text-primary/40 italic font-semibold">
